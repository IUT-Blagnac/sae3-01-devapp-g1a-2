...
On peut voir ses informations utilisateur, puis remplir ses informations de carte bancaire indiqué en bleu, pour effectuer le paiement. Le prix total de la commande est affiché.

image::./images/infoPaiement.png[Image affichage page livraison coché]
