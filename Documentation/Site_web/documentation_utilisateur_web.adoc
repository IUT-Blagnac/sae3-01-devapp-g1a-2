...
Une fois une catégorie d'article affichée, l'utilisateur pourra choisi comment il souhaite disposer les articles.
...
On voit ensuite l'affichage des produits ajoutés au panier et un récapitulaif de commande.
...
On peut choisir pour chaque produits de réduire la quantité de 1, ou de supprimer complètement l'article du panier.
image::./images/modifpanier1.png[Image affichage bouton supprmier]
