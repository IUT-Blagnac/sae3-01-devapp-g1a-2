...
On voit ensuite l'affichage des produits ajoutés au panier et un récapitulaif de commande. Pour finaliser la commande, on peut cliquer sur le bouton " passer la commande ".
