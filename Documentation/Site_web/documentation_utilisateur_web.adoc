...
On peut choisir entre 2 modes de livraison. Une fois la livraison choisis, le prix de livraison est actualisé en fonction du choix de livraison. On pourra ensuite passer à l'étape suivante.
